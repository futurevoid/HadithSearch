...
<html>
<div id="container">
<div id="intro">  <h1>هذا الموقع يعرض احاديث الرسول الله  ﷺ<br>(محتوى الحديث)مصنفه بالمتن<br>و الاحاديث جميعها مصحوبه<br> بالراوي و المحدث و كتابه و رقم<br> الحديث او الصفحه و درجة الصحه</h1></div>
